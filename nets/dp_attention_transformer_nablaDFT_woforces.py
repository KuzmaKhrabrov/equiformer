...
class DotProductAttentionTransformerNablaDFTwoForces(torch.nn.Module):
    def __init__(self,
        irreps_in='64x0e',
...
@register_model
def dot_product_attention_transformer_exp_l2_nablaDFTwoforces(irreps_in, radius, num_basis=128, 
    atomref=None, task_mean=None, task_std=None, **kwargs):
    model = DotProductAttentionTransformerNablaDFTwoForces(
        irreps_in=irreps_in,
        irreps_node_embedding='128x0e+64x1e+32x2e', num_layers=6,
        irreps_node_attr='1x0e', irreps_sh='1x0e+1x1e+1x2e',
        max_radius=radius,
...
@register_model
def dot_product_attention_transformer_exp_l3_nablaDFTwoforces(irreps_in, radius, num_basis=128, 
    atomref=None, task_mean=None, task_std=None, **kwargs):
    model = DotProductAttentionTransformerNablaDFTwoForces(
        irreps_in=irreps_in,
