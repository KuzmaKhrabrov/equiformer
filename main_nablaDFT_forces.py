...
import datasets.pyg.nablaDFT as nablaDFT_dataset
...
def get_args_parser():
    parser = argparse.ArgumentParser('Training equivariant networks on nablaDFT with forces', add_help=False)
...
def main(args):
    ...
    ''' Dataset '''
    train_dataset, val_dataset, test_dataset = nablaDFT_dataset.get_nablaDFT_datasets(
